...
urlpatterns = [
    ...
    path('firmalar/ekle/', accounts_views.firma_ekle, name='firma_ekle'),
    path('firmalar/<int:firma_id>/duzenle/', accounts_views.firma_duzenle, name='firma_duzenle'),
    path('firmalar/<int:firma_id>/durum/', accounts_views.firma_durum_degistir, name='firma_durum_degistir'),
    ...
    path('senet-takip/ekle/', accounts_views.senet_ekle, name='senet_ekle'),
    path('senet-takip/<int:senet_id>/duzenle/', accounts_views.senet_duzenle, name='senet_duzenle'),
    path('senet-takip/<int:senet_id>/durum/', accounts_views.senet_durum_degistir, name='senet_durum_degistir'),
    path('senet-takip/<int:senet_id>/sil/', accounts_views.senet_sil, name='senet_sil'),
